    ...
    public void fillGGTable(ArrayList<GiamGia> list){
        ...
        for (GiamGia giamGia : list) {
            dtmGG.addRow(new Object[]{
                ...
                giamGia.getGiaTriToiThieu(),
                giamGia.getGiaTriToiDa(),
...
try {
    String input = txtGiamPT.getText().replaceAll("[^\\d.]", ""); // loại bỏ mọi ký tự không phải số hoặc dấu chấm
    ...
    return null;
     ...
     private void showTable(int index) {
        ...
        txtGiamPT.setText(gg.getPhanTramGiam()+"");
